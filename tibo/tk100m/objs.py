...
from tk100m.tiktokdownloader import TikTokDownloader
...
class video_obj():
    def __init__(self, video_item_data, local_download_path="", edited_path=""):
        ...
        self.cover_url = video_item_data['video']['cover']
    ...
    def create_datapoint(self):
        ...
        datapoint['cover_url'] = self.cover_url
    ...
    def download(self):
        ...
        try:
            ...
            print(f"{self.id} - Download failed. Retrying...")
            ...
            try:
                ...
                print(f"{self.id} - [Last] Download failed.")
    ...
    def make_combination_files(self):
        ...
        for video_id, row in self.info_df.iterrows():
            try:
                ...
                print(f"{video_id} - Download failed. Continued.")
