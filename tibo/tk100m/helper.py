...
def load_tags_from_file(tags_file_path=f"{conf.storage_dir}/specific_tags.txt"):
    tags = []
...
# def connect_mongodb(username="thuc",password="thuc1010"):
#     # client = MongoClient(r"mongodb+srv://thuc:thuc1010@tkcluster.kz7gb.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
#     client = MongoClient(f"mongodb://{username}:{password}@tkcluster.kz7gb.mongodb.net/")
#     return client
